        ...
        <div className="flex flex-col gap-9">
          ...
          <div className="flex flex-col gap-5">
            <p className="text-base sm:text-[20px] font-normal leading-loose text-justify">
              Hi again! I'm <span className="text-[#76d32e] font-bold">Muhammad Jawwad</span>, a passionate{" "}
              <span className="text-[#76d32e] font-bold">Web Developer</span> from{" "}
            ...
            <a
              target="_blank"
              href="https://www.linkedin.com/in/muhammad-jawwad-842b29312/"
